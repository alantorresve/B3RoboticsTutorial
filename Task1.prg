...
If ITEM_TYPE = 0 Then
    ...
    On 8
    Wait 0.5
    Go TF +Z(HEIGHT * 6) +Z(10) +Y(5) /2 ' Secure Token Feeder
    HEIGHT = HEIGHT - 1
    Go TA +Z(15) +Y(5) /2 ' Secure Token Aligner
    Go TA ' Token Aligner
    Off 8
    Go TA +Y(-10) /2
    Go TA +Y(-10) +Z(10) /2
...
Go PT1 +Z(10) +Y(ITEM_POS * 30) +X(ITEM_TYPE * 31) /2 ' Secure Place
Go PT1 +Z(5) +Y(ITEM_POS * 30) +X(ITEM_TYPE * 31) /2
